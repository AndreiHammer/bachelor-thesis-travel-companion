...
fun LocationSearchScreen(
    ...
    Scaffold(
        ...
        topBar = {
            CompanionTopAppBar(
                title = stringResource(R.string.app_name_2),
                onNavigationClick = { /* No back navigation in this screen */ },
                scrollBehavior = scrollBehavior,
                navigationIcon = { /* No navigation icon for home screen */ },
                actions = {
                    IconButton(
                        onClick = { onAction(LocationSearchAction.OnProfileClick) }
                    ) {
                        Icon(
